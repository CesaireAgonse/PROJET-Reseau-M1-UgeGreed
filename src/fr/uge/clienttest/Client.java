...
public class Client {
    ...
    public static void printRange(Checker checker, int start, int end) throws InterruptedException {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        checker = checkerFromDisk(Path.of("JarTest/Collatz.jar"),"fr.uge.collatz.Collatz").orElseThrow();
        System.out.println(checker.check(12L));
